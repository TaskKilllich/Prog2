...
def ImprimirABT(arbol):
    ...
    pixs = 17                 # Multiplicador x resolución monitor
    if (tam >= 32):
        pixs = 22

    letra=('Arial', 8, 'normal')
    coox = -pixs * (1 + tam//2.5)     # Ajustar x para centrar en la pantalla
    cooy = 80
    radc = 13
